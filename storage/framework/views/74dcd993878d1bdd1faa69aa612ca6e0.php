...
<div>
    <div class="row">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $computers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $computer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($status === 'available'): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($status === 'in_use'): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($upcoming->isNotEmpty()): ?>
                            <div class="mb-3">
                                <small class="fw-semibold text-muted d-block mb-2">Jadwal hari ini:</small>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $upcoming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\chilby-internetcafe\resources\views/livewire/pages/customer/booking-list.blade.php ENDPATH**/ ?>