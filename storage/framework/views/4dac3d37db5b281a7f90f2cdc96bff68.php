        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $current_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                            <span class="badge bg-label-secondary">
                                <?php echo e(substr($booking->id, 0, 8)); ?>
                            ...
                            <td>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($booking->rescheduled_from_id): ?>
                                    <br><small class="text-info"><i class="bx bx-calendar-edit"></i> Rescheduled</small>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td>
                                <!--[if BLOCK]><![endif]--><?php if($booking->payment_status === 'paid'): ?>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <!--[if BLOCK]><![endif]--><?php if($booking->payment_status === 'paid' && $booking->midtrans_order_id): ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($booking->payment_status === 'pending' && $booking->midtrans_order_id): ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(now()->lt($booking->booking_start_date->copy()->subHours(2))): ?>

                                        <a href="<?php echo e(route('customer.booking.reschedule', $booking->id)); ?>"
                                        class="dropdown-item">
    ...
    <div class="card">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $completed_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                            <span class="badge bg-label-secondary">
                                <?php echo e(substr($booking->id, 0, 8)); ?>
...
<?php /**PATH C:\laragon\www\chilby-internetcafe\resources\views/livewire/pages/customer/history-list.blade.php ENDPATH**/ ?>