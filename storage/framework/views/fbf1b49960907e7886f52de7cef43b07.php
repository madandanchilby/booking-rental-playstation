                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['new_computer_id'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-6">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['new_booking_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <small class="text-muted d-block mb-3">
                            <!--[if BLOCK]><![endif]--><?php if($max_slots === 1): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['new_booking_times'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
