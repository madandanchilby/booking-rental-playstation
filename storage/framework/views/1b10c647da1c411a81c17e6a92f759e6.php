...
<div>
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <!--[if BLOCK]><![endif]--><?php if($paymentStatus === 'paid'): ?>
                        ...
                        <div class="bg-light rounded p-3 mb-4 text-start">
                            <div class="row">
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <div class="fw-semibold"><?php echo e($bookingId); ?></div>
                                </div>
                                <div class="col-sm-6 mb-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!empty($bookingSlots)): ?>
                                <hr>
                                <small class="text-muted">Jadwal Booking</small>
                                <div class="d-flex flex-wrap gap-2 mt-1">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $bookingSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-2">
                            <!--[if BLOCK]><![endif]--><?php if($snapToken): ?>
...
<!--[if BLOCK]><![endif]--><?php if($paymentStatus === 'pending' && $snapToken): ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH C:\laragon\www\chilby-internetcafe\resources\views/livewire/pages/customer/booking-payment.blade.php ENDPATH**/ ?>