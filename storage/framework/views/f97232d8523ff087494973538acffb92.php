                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $current_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <span class="badge bg-label-secondary">
                                <?php echo e(strtoupper(substr($booking->id, 0, 8))); ?>

                            </span>
                            </td>
                            <td>
                                <!--[if BLOCK]><![endif]--><?php if($booking->booking_type === 'walk_in'): ?>
                            ...
                            <td>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($booking->isWalkIn() && $booking->customer_phone_walkin): ?>
...
<?php /**PATH C:\laragon\www\chilby-internetcafe\resources\views/livewire/pages/admin/history-list.blade.php ENDPATH**/ ?>